 ...
 * form the integral number, which are ignored and have no 
 ...
 * values, 231 − 1 or −231 is returned.
 * @param {string} str
 * @return {number}
 */
var myAtoi = function (str) {
    str = str.trim();
    let found = str.match('^(?:\\+|\\-)?[0-9]+');
    if (found === null) { return 0; }
    let n = parseInt(found[0]);
    if (n >= Math.pow(2, 31)) {
    ...
    return n;
    /**
     * Runtime: 92 ms, faster than 93.64% of JavaScript online submissions for String to Integer (atoi).
     * Memory Usage: 40.5 MB, less than 68.65% of JavaScript online submissions for String to Integer (atoi).
     */
};
/**
 * Example 1:
