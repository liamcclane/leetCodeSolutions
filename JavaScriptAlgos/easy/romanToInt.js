...
var romanToInt = function (s) {
     ...
     * Your runtime beats 81.01 % of javascript submissions.
     * Your memory usage beats 61.96 % of javascript submissions.
     */
};
...
console.log();
console.log(romanToInt("MMXIX")); // 2019